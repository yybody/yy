		...
		<div class="clearfixLeft" id="clearcontent">
			...
			<div class="box">
				...
				<div class="tb-booth tb-pic tb-s310">
					<a href="${good.gpic}"><img src="${good.gpic}" alt="细节展示放大镜特效" rel="" class="jqzoom" /></a>
				</div>
			...
			<div class="tb-detail-list">
				...
				<div class="tb-detail-price">
					<li class="price iteminfo_price">
						<dt>促销价</dt>
						<dd><em>¥</em><b class="sys_item_price">${good.gdiscount*good.gprice}</b>  </dd>
					</li>
					<li class="price iteminfo_mktprice">
						<dt>原价</dt>
						<dd><em>¥</em><b class="sys_item_mktprice">${good.gprice}</b></dd>
					</li>
					<div class="clear"></div>
				</div>
				...
				<dl class="iteminfo_parameter sys_item_specpara">
					...
					<dd>
						<input id="m" class="am-btn am-btn-default" name="" type="button" value="-" />
					    <input type="hidden" id="gid" value="${good.gid}" />
						<input id="text_box" name="" type="text" value="1" style="width:30px;" />
						<input id="a" class="am-btn am-btn-default" name="" type="button" value="+" />
						<span id="Stock" class="tb-hidden">库存<span class="stock">${good.qty}</span>件</span>
					</dd>
...
<script>
	...
	$("#LikBasket").click(function () {
		...
		window.location.href="/Dg/shop/goods?gid=${good.gid}&rl="+s+""
    })
    ...
    $(document).ready(function() {
        ...
        $("#a").click(function() {
            ...
            $.ajax({
                url: "http://localhost:8080/Dg/shop/check",
                data: JSON.stringify({"amount": (parseInt(t.val())+1).toString(),"goods":{"gid":""+${good.gid}}}),
                dataType: "json",
